...
AESTHETIC = True   #Removes all internal detail, works best with INVERSE
INVERSE = True     #Also includes the inverse of the model as a separate file
...
MODEL_THRESH = 0.05  #Influences the number of cells in the model, larger values lead to more cells
MODEL_SHELL = 0#3     #Sets the thickness of the model skin (in voxels), set to 0 for aesthetic models
MODEL_CELL = 7#0.9     #Sets the thickness of the cell walls within the model (in voxels)
